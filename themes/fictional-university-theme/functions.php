...
//	wp_enqueue_script('university-js', get_theme_file_uri('/js/scripts.js'), NULL, '1.0', true);
//	wp_enqueue_script('university-slide-js', get_theme_file_uri('/js/modules/HeroSlider.js'), NULL, '1.0', true);
	//manually add search.js
//	wp_enqueue_script('university-search-js', get_theme_file_uri('/js/modules/Search.js'), NULL, '1.0', true);
